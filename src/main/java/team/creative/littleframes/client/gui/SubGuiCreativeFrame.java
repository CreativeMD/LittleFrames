...
public class SubGuiCreativeFrame extends SubGui {
	...
	public void createControls() {
		...
		controls.add(new GuiStateButton("posX", frame.min.x == 0 ? 0 : frame.max.x == 1 ? 2 : 1, 0, 68, 70, translate("gui.creative_frame.posX.left"), translate("gui.creative_frame.posX.center"), translate("gui.creative_frame.posX.right")));
		controls.add(new GuiStateButton("posY", frame.min.y == 0 ? 0 : frame.max.y == 1 ? 2 : 1, 80, 68, 70, translate("gui.creative_frame.posY.top"), translate("gui.creative_frame.posY.center"), translate("gui.creative_frame.posY.bottom")));
