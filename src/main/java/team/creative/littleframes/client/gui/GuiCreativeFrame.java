...
public class GuiCreativeFrame extends GuiLayer {
    ...
    public GuiCreativeFrame(BECreativeFrame frame) {
        this(frame, false, 16);
    }
    
    public GuiCreativeFrame(BECreativeFrame frame, boolean editFacing, int scaleSize) {
