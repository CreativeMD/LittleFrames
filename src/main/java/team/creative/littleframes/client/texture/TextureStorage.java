...
public class TextureStorage {
    ...
    private final File cacheDirectory = new File(Minecraft.getInstance().gameDirectory, "littleframe_cache");
    ...
    public void save(String url, String etag, long time, long expireTime, byte[] data) {
        ...
        try {
            ...
            TextureSeeker.LOGGER.error("Failed to save cache entry {}", e, url);
        } finally {
    ...
    private static File getFile(String url) {
        return new File(TextureSeeker.TEXTURE_STORAGE.cacheDirectory, Base64.encodeBase64String(url.getBytes()));
    }
    ...
    public static class CacheEntry {
        ...
        public File getFile() {
            return TextureStorage.getFile(url);
        }
    }
}
