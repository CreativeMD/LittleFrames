...
public class LittleTilesIntegration {
    ...
    public static final LittleStructureGuiCreator LITTLE_FRAME_GUI = GuiCreator.register("little_frame", new LittleStructureGuiCreator((nbt, player,
            structure) -> new GuiLittlePictureFrame((LittlePictureFrame) structure), x -> true));
